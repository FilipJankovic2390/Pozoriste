		...
		<div class="panel panel-danger">
  			...
  			<table class="table table-striped table-bordered">
  				<tbody>
  					...
  					<tr><td>Napraviti pogled koji za svakog pretplatnika prikazuje koliko je ukupno novca potrošio na sve rezervacije koje je napravio, kao i broj kreditne kartice kojom izmiruje obaveze</td><td><a class="btn btn-success disabled" href="izvestaj-5.php" role="button">Prikaži</a></td></tr>
  				</tbody>
  			</table>
		</div>		
	</div>
...
<div class="row">
	<div class="col-xs-12">
		<div class="panel panel-danger">
  			<div class="panel-heading">Pogled koji za svakog pretplatnika prikazuje koliko je ukupno novca potrošio na sve rezervacije koje je napravio, kao i broj kreditne kartice kojom izmiruje obaveze</div>

			<?php 
		        $sql = "SELECT rezervacije.PRETPLATNIK_ID, pretplatnik.PRETPLATNIK_IME, pretplatnik.BROJ_KARTICE, pretplatnik.VRSTA_KARTICE, pretplatnik.DATUM_ISTICANJA, SUM(rezervacije.UKUPAN_IZNOS) AS ukupan_iznos FROM rezervacije INNER JOIN pretplatnik ON pretplatnik.PRETPLATNIK_ID=rezervacije.PRETPLATNIK_ID GROUP BY rezervacije.PRETPLATNIK_ID ORDER BY ukupan_iznos DESC";
		        $result = $conn->query($sql);

		        echo "<table class='table table-striped table-bordered'><thead><tr><th>Ime pretplatnika</th><th>Tip kartice</th><th>Broj kartice</th><th>Datum isticanja</th><th>Ukupan iznos</th></tr></thead><tbody>";
