		...
		<div class="panel panel-danger">
  			...
  			<table class="table table-striped table-bordered">
  				<tbody>
  					...
  					<tr><td>Pronaći podatke o producentu koji ima najviše različitih predstava za koje više nema slobodnih mesta</td><td><a class="btn btn-success disabled" href="izvestaj-3.php" role="button">Prikaži</a></td></tr>
...
<div class="row">
	<div class="col-xs-12">
		<div class="panel panel-danger">
  			<div class="panel-heading">Producent koji ima najviše različitih predstava za koje više nema slobodnih mesta</div>

			<table class='table table-striped table-bordered'><tr><td>Nema rezultata</td></tr></table>
